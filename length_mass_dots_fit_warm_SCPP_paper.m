...
if (kk==1)
    h=scatter(LENGTH(1:idx).*1E4,mass(1:idx).*1E3,'v');%,'black','LineWidth',3);
    set(h,'MarkerEdgeColor','k','MarkerFaceColor','k','LineWidth',0.6)
elseif (kk==2)
    h=scatter(LENGTH(1:idx).*1E4,mass(1:idx).*1E3,'s');%,'black','LineWidth',3);
    set(h,'MarkerEdgeColor',blu,'MarkerFaceColor',blu,'LineWidth',0.6)
elseif (kk==3)
    h=scatter(LENGTH(1:idx).*1E4,mass(1:idx).*1E3,'d');%,'black','LineWidth',3);
    set(h,'MarkerEdgeColor','r','MarkerFaceColor','r','LineWidth',0.6)
elseif (kk==4)
    h=scatter(LENGTH(1:idx).*1E4,mass(1:idx).*1E3,'^');%,'black','LineWidth',3);
...
% h=scatter(L_tot.*1E4,m_tot.*1E3,'o');%,'black','LineWidth',3);
% set(h,'MarkerEdgeColor','b','MarkerFaceColor',grey,'LineWidth',0.6)
% hold on

L_max = 25*1E-4:1E-4:0.6 ; %max(L_tot) ;

 crvft2 = -0.151201.*log(L_max).^2 + 1.15394.*log(L_max) - 7.06562 ;
